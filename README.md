# Virtual Immersive Behavioral Sciences (VIBES) Lab – **Project 2: A Comparison of the Near-Win Effect in College Athletes and Non-Athletes**
...
### **Demo Available**
[Watch the system in action](https://youtu.be/UyMlnB-UjvM?si=msq0Bknm4o1UpLFQ)
...
| VR Platform | SteamVR |
| Programming | C# |
| Data Processing | [Web-based CSV Processor](https://github.com/JohnBacho/Vibes-Lab-Project2-CSV-Processor) |
...
2. Install [SRanipal runtime](https://docs.vrcft.io/docs/v4.0/hardware/VIVE/sranipal)
